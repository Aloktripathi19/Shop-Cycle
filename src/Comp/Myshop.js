...
function Myshop() {
    ...
    useEffect(() => {
        ...
        if (obj.state._id) {
            ...
            axios.get(`${process.env.REACT_APP_BASE_URL}/myshop/${obj.state._id}`, { "headers": { "Authorization": obj.state.token } }).then((res) => {
                udata(res.data)
    ...
    let toggle = (id, open) => {
        axios.put(`${process.env.REACT_APP_BASE_URL}/shopon/${id}`, { open: !open }).then((res) => {
            setF(!f)
        })
    }
                    ...
                    return (
                        ...
                        <div className="my-box">
                            <div className="my-img">
                                <img src={`${process.env.REACT_APP_BASE_URL}/simgs/${shopData.simg}`} alt="Shop" className="shop-image" />
                            </div>
